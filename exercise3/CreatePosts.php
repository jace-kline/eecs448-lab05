...
if ($result->num_rows == 0) {
    echo "<br><p style='font-size:30px'>Invalid user. The inputted user name <b>" . $_POST["nameInput"] . "</b> is not registered.</p>";
} 
    ...
    $result->free();
    $mysqli->query("INSERT INTO Posts (author_id, content) VALUES ('" . $_POST["nameInput"] . "', '" . $_POST["post"] .  "')");
